...
public class Currency {
    ...
    // Method to get the exchange rate for a given target currency
    public double getExchangeRate(String targetCurrency) {
        return this.exchangeValues.getOrDefault(targetCurrency, 0.0);
    }
    ...
    // Method to initialize currencies with their default values
    ...
    // Convert a currency to another currency using exchange rate
